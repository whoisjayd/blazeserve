...
BlazeServe support is routed by request type so maintainers and community members can find the right context quickly.
...
BlazeServe is maintained as a small open-source project. Maintainers will triage requests as time allows. Security reports receive the acknowledgment and handling described in [SECURITY.md](SECURITY.md), including acknowledgment within 72 hours.

For community standards and project decision-making, see the [Code of Conduct](CODE_OF_CONDUCT.md) and [Governance](GOVERNANCE.md).
